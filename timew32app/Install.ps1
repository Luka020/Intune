$Scriptname = "ttimesync.ps1" #name of the script to run in the scheduled task. Put in to root folder of this package.
$Foldername = "Scripts" #Foldername in C:\Program Files\
$ScheduledTaskUser = "SYSTEM" #This is the user that is used to run the scheduled task, default set as system
$ScheduledTaskName = "Syncthetime" #name of the scheduled task
